...
import { imagesToSave, jotaiDetails, jotaiError, jotaiFileLimit, jotaiLimitCount, jotaiImages, jotaiIsDraggedOver } from '../JotaiAtoms';
...
const useSelectFile = (): UseSelectFileReturnType => {
  ...
  return {images, handleSelectFile, setImages, error, blobImage, setBlobImage, details, handleDeleteImage, handleDropFile, isDraggedOver};
};
